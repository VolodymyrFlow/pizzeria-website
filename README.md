...
Started Project 3: Italian Pizzeria Website.
...
- Added Hero section
- Added restaurant branding
- Created first Italian-style design
...
- How to organize a new project from the beginning
- How to create a navigation bar
- How to build a Hero section
- How to use Flexbox for layout
- How to connect design and structure together
- How to initialize a Git repository

## Project Status

Project 3: Italian Pizzeria Website
...
- Created CTA button linking to Menu section
- Improved Hero section alignment and spacing
- Styled navigation links with hover effects
- Built responsive layout for tablets and mobile devices
- Improved Menu, About and Contact sections
- Added image support for pizza cards
- Created assets folder structure for menu images
...
- Fixed CSS selector conflicts
- Fixed invalid rgba/rhba typo
- Fixed Hero section positioning on large screens
...
- How image imports work in React
- Difference between padding and margin
- How Flexbox centers content
- How Grid creates card layouts
- How CSS class conflicts can break styling
- Debugging real-world UI issues

### Next Steps

- Add pizza images to menu cards
- Create menu data array and render with map()
